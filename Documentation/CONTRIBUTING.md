# Contributing to ED Inara Overlay 2.0
...
|---------|---------|---------------|
| `ED_Inara_Overlay_2.0/` | Main WPF application with overlay UI | C# / .NET 8 / WPF |
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/your-username/ED_Inara_Overlay_2.0.git
   cd ED_Inara_Overlay_2.0
   ```
...
1. **Understand Dependencies**
   - `ED_Inara_Overlay_2.0` depends on `InaraTools` and `Logger`
...
2. **Cross-Component Development**
   ...
   - UI-specific code belongs in `ED_Inara_Overlay_2.0`
...
powershell -ExecutionPolicy Bypass -File ED_Inara_Overlay_2.0/RegressionTest.ps1
```
